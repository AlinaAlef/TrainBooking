...
<td><input type="submit" class="button-accept" name="suite${route.id}_${departureDate}" value="Вибрати"/></td>
<td><input type="submit" class="button-accept" name="coupe${route.id}_${departureDate}" value="Вибрати"/></td>
<td><input type="submit" class="button-accept" name="berth${route.id}_${departureDate}" value="Вибрати"/></td>
</tr>
</c:forEach>
</table>
</form>
